...
ros::init(argc , argv , "min_publisher"); // name of this node will be "minimal_publisher"
...
// expect one core to be 100% dedicated ( wastefully ) to this small task input_float . data = input_float . data + 0.001; // increment by 0.001 each  - iteration
